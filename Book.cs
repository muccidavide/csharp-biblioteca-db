...
public class Book : Document
{
    ...
    public Book(int isbn, string title, string section, bool available, string position, string author, int year, int duration, string firstName, string lastName, string email, string password, long phoneNumber) : base(firstName, lastName, email, password, phoneNumber, isbn,  title, section, available, position, author, year, duration)
    {
